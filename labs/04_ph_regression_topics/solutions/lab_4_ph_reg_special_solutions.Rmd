...
b) Use a Cox PH model with a robust standard error to estimate the unadjusted treatment effect of thiotepa of bladder cancer in a marginal model, using the WLW approach.
