---
title: "Estimation with Event-Time Data"
...
- units for cumulative hazard
- replace hats with widehats
- illustrate use of survminer
...
Use the same approach by grouping the event times into
intervals (say, one interval for each month),  then counting
up the number of deaths (events) in each to estimate the probability
of surviving the interval (this is called the *lifetable estimate*).

\begin{center}
\begin{tabular}{l|p{.4in}|p{.4in}|p{.4in}
 |p{.4in}|p{.4in}|p{.4in}|p{.4in}|p{.4in}|p{.4in}|p{.4in}
 |p{.4in}|p{.4in}|p{.4in}|p{.4in}|p{.4in}}
  &   &  &   & &   & &   & C &   &   &   & \\
  &   &  & D & & C & & C & D & D & D & C & \\  \hline
& \multicolumn{4}{|c|}{--Month 1--} 
& \multicolumn{4}{|c|}{--Month 2--} 
& \multicolumn{4}{|c|}{--Month 3--} \\
\end{tabular}
\end{center}

However, the assumption that those censored survive until the end of the interval wouldn't be quite accurate, so the approximation would not be a good one
...
<!--- 
Lindsey JC, Ryan L
Tutorial in biostatistics: methods for interval-censored data (vol 17, pg
219, 1998)
STAT MED 18: (7) 890-890 APR 15 1999 
