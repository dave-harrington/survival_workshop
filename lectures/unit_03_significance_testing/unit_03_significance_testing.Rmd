---
title: "Significance Testing: The Log-Rank and Weighted Log-Rank Tests"
...
Let $\tau_1, \ldots, \tau_K$ represent the $K$ ordered, distinct failure times in the pooled sample.
...
- Let  $\tau_{1s}, \ldots ,\tau_{K_s s}$ represent the $K_s$ ordered, distinct death
